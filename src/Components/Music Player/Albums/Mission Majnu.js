...
const Majnu = [
  {
    "title": "Channa Ve Assi Marjawange",
    "music": "Music/Albums/Mission Majnu/Channa Ve Assi Marjawange.mp3",
    "artist": "Raj Barman",
    "img": "Albums/Mission/Channa.jpg",
    "duration": "02:41",
    "id": 1
  },
  {
    "title": "Maati Ko Maa Kehta Hain",
    "music": "Music/Albums/Mission Majnu/Maati Ko Maa Kehte Hain.mp3",
    "artist": "Sonu Nigam, Rochak Kohli",
    "img": "Albums/Mission/Maati.jpg",
    "duration": "03:13",
    "id": 2
  },
  {
    "title": "Rabba Janda",
    "music": "Music/Albums/Mission Majnu/Rabba Janda.mp3",
    "artist": "Jubin Nautiyal, Tanishk Bagchi, Shabbir Ahmed",
    "img": "Albums/Mission/Rabba.jpg",
    "duration": "03:03",
    "id": 3
  },
  {
    "title": "Tum Ho",
    "music": "Music/Albums/Mission Majnu/Tum Ho.mp3",
    "artist": "Papon",
    "img": "Albums/Mission/Tum Ho.jfif",
    "duration": "02:46",
    "id": 4
  }
]
...
function MajnuAlbum() {
  const [select, setSelect] = useState(Majnu[0].music);
  ...
  const handleChange4 = () => {
    if (fav4) {
      ...
      setstate4(true)
      setClick(false);
      dispatch(removeToFav(Majnu[3]))
    }
  }
  // for 1
  useEffect(() => {
    if (!fav1 || state1) {
      window.localStorage.setItem('fav_color1_m', JSON.stringify(color1))
      window.localStorage.setItem('fav_state1_m', JSON.stringify(fav1))
    }
  })
  useEffect(() => {
    const get = window.localStorage.getItem('fav_color1_m');
    const get1 = window.localStorage.getItem('fav_state1_m');
  ...
  useEffect(() => {
    if (!fav2 || state2) {
      window.localStorage.setItem('fav_color2_m', JSON.stringify(color2))
      window.localStorage.setItem('fav_state2_m', JSON.stringify(fav2))
    }
  })
  useEffect(() => {
    const get = window.localStorage.getItem('fav_color2_m');
    const get1 = window.localStorage.getItem('fav_state2_m');
  ...
  useEffect(() => {
    if (!fav3 || state3) {
      window.localStorage.setItem('fav_color3_m', JSON.stringify(color3))
      window.localStorage.setItem('fav_state3_m', JSON.stringify(fav3))
    }
  })
  useEffect(() => {
    const get = window.localStorage.getItem('fav_color3_m');
    const get1 = window.localStorage.getItem('fav_state3_m');
  ...
  useEffect(() => {
    if (!fav4 || state4) {
      window.localStorage.setItem('fav_color4_m', JSON.stringify(color4))
      window.localStorage.setItem('fav_state4_m', JSON.stringify(fav4))
    }
  })
  useEffect(() => {
    const get = window.localStorage.getItem('fav_color4_m');
    const get1 = window.localStorage.getItem('fav_state4_m');
    ...
    <div className="Head">
      ...
      <div className="main_bh">
        ...
        <div className="Wallpaper">
          <img src="Albums/Wallpaper/mission majnu.jpg" alt="Error" />
        </div>
        ...
        <div className="list_head">
          ...
          <div id="Album_artist_mission">
            Artists
          </div>
          <div id="Album_Mission_duration">
          Duration
          </div>
        </div>
        <div className="list">
        ...
        {/* For empty space */}
        <div className="space" id="Mission_space"></div>
      </div>
    </div>
  );
}

export default MajnuAlbum;